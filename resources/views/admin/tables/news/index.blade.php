                    ...
                    <table class="w-full table-fixed border-collapse">
                        ...
                        <tbody class="text-gray-600 text-sm font-light" id="newsTableBody">
                            @forelse($news as $item)
                                <tr class="border-b border-gray-200 hover:bg-gray-100 transition-colors duration-200">
                                    ...
                                    <td class="py-4 px-6 text-left text-xs">
                                        <code class="text-[#FF7518] font-bold">
                                            {{ strtoupper(pathinfo($item->image, PATHINFO_EXTENSION)) }}
                                        </code>
                                    </td>
                            ...
                            <tr id="no-results" class="hidden">
                                <td colspan="8" class="py-8 text-center text-gray-500">Berita tidak ditemukan.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
