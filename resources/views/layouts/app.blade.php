...
<head>
    ...
    <style>
        ...
        /* Navbar Styling */
        .nav-link {
            @apply relative text-gray-700 px-2 py-2 transition-all duration-300 flex items-center text-[11px] xl:text-[13px] font-bold uppercase tracking-wider whitespace-nowrap;
        }
...
<body class="bg-gray-50 font-sans text-gray-900 pt-[70px] lg:pt-[110px]">
    ...
    <div x-data="{ searchModalOpen: false, mobileMenuOpen: false }" @keydown.escape.window="searchModalOpen = false">
        ...
        {{-- MODAL SEARCH --}}
        <div x-show="searchModalOpen" x-transition:enter="transition-opacity ease-out duration-300"
            ...
            <div
                class="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
                <form action="{{ route('search') }}" method="GET" class="relative">
                    <input type="text" name="query"
                        class="w-full text-lg md:text-xl py-5 md:py-6 pl-12 md:pl-14 pr-6 focus:ring-0 border-none outline-none font-sans"
                        placeholder="Cari layanan..." autofocus>
            ...
            <div class="max-w-screen-xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-3">
                ...
                <a href="/" class="flex items-center gap-2 md:gap-3 group shrink-0">
                    <img src="{{ asset('assets/img/image.png') }}" alt="Logo"
                        class="h-9 w-auto md:h-11 transition-transform group-hover:scale-105">
                    <div class="flex flex-col border-l border-gray-200 pl-2 md:pl-3">
                        <span
                            class="text-rbm-dark font-times text-[10px] sm:text-sm md:text-lg font-bold leading-tight uppercase tracking-tighter">
                            PT RIZQALLAH BOER MAKMUR
                        </span>
                        <span
                            class="text-[7px] md:text-xs font-sans text-gray-500 font-medium tracking-[0.2em] uppercase opacity-80">
                ...
                <div class="hidden lg:flex items-center space-x-4">
                    ...
                    <a href="https://wa.me/{{ $whatsappNumber }}" target="_blank"
                        class="bg-rbm-accent text-white px-5 py-2 rounded-full font-bold hover:bg-orange-600 transition-all text-[11px] shadow-md flex items-center gap-2">
                ...
                <div class="lg:hidden flex items-center gap-1">
                    ...
                    <button @click="mobileMenuOpen = !mobileMenuOpen"
                        class="text-xl text-rbm-dark p-2 focus:outline-none transition-transform"
                ...
                <div class="max-w-screen-xl mx-auto flex items-center justify-center gap-x-6 xl:gap-x-8 px-4 h-11">
                    ...
                    <div class="relative group h-full flex items-center">
                        <button class="nav-link">Perusahaan <i
                                class="fa-solid fa-chevron-down ml-1 text-[8px]"></i></button>
                        <div
                            class="absolute top-full dropdown-content bg-white shadow-2xl border border-gray-100 rounded-b-xl py-2 w-52 overflow-hidden z-[60]">
                            <a href="{{ route('about') }}"
                            ...
                            <a href="{{ route('partners.index') }}"
                                class="block px-5 py-3 text-sm text-gray-600 hover:bg-orange-50 hover:text-rbm-accent transition-colors">Customer
                                Kami</a>
...
<<<<<<< HEAD
                    ...
                    <div class="relative group h-full flex items-center">
                        <button class="nav-link">Bantuan <i
                                class="fa-solid fa-chevron-down ml-1 text-[8px]"></i></button>
                        <div
                            class="absolute top-full dropdown-content bg-white shadow-2xl border border-gray-100 rounded-b-xl py-2 w-48 overflow-hidden z-[60]">
                            <a href="{{ route('faq') }}"
...
>>>>>>> 2c511e552552d96062ee847ba50016ea48df3f82
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <div x-show="mobileMenuOpen" x-cloak x-transition:enter="transition ease-out duration-200"
                ...
                class="lg:hidden bg-white w-full border-t border-gray-100 shadow-2xl overflow-y-auto max-h-[85vh]">
                <div class="p-4 space-y-1">
                    <a href="/"
                        class="block px-4 py-3 rounded-xl text-[13px] font-bold {{ Request::is('/') ? 'bg-orange-50 text-rbm-accent' : 'text-gray-700' }}">HOME</a>

                    <div x-data="{ open: false }">
                        <button @click="open = !open"
                            class="w-full flex justify-between items-center px-4 py-3 text-gray-700 font-bold text-[13px] uppercase">
                        ...
                        <div x-show="open" x-collapse class="bg-gray-50 rounded-xl mx-2 my-1 overflow-hidden">
                            <a href="{{ route('about') }}"
                                class="block px-6 py-3 text-[12px] text-gray-600 font-medium">Tentang Kami</a>
                            <a href="{{ route('gallery.index') }}"
                                class="block px-6 py-3 text-[12px] text-gray-600 font-medium">Galeri Proyek</a>
                            <a href="{{ route('partners.index') }}"
                                class="block px-6 py-3 text-[12px] text-gray-600 font-medium">Customer Kami</a>
                            <a href="{{ route('testimonials.index') }}"
                                class="block px-6 py-3 text-[12px] text-gray-600 font-medium">Testimonial</a>
                        </div>
                    </div>

                    <a href="{{ route('products') }}"
                        class="block px-4 py-3 text-gray-700 font-bold text-[13px] uppercase {{ Request::is('products*') ? 'text-rbm-accent' : '' }}">Produk</a>
                    <a href="{{ route('news.index') }}"
                        class="block px-4 py-3 text-gray-700 font-bold text-[13px] uppercase {{ Request::is('news*') ? 'text-rbm-accent' : '' }}">Berita</a>
                    <a href="{{ route('facilities.index') }}"
                        class="block px-4 py-3 text-gray-700 font-bold text-[13px] uppercase">Fasilitas</a>
                    <a href="{{ route('kontak') }}"
                        class="block px-4 py-3 text-gray-700 font-bold text-[13px] uppercase">Kontak</a>

<<<<<<< HEAD
                    {{-- FIXED: MENU FEEDBACK UNTUK MOBILE --}}
                    <a href="{{ route('feedback.create') }}"
                        class="block px-4 py-3 text-gray-700 font-bold text-[13px] uppercase {{ Request::is('feedback*') ? 'text-rbm-accent' : '' }}">
                        Feedback
                    </a>
...
<<<<<<< HEAD
                            <a href="{{ route('faq') }}"
                                class="block px-6 py-3 text-[12px] text-gray-600 font-medium">FAQs</a>
                            <a href="{{ route('syaratketentuan') }}"
                                class="block px-6 py-3 text-[12px] text-gray-600 font-medium">Legalitas</a>
=======
...
>>>>>>> 2c511e552552d96062ee847ba50016ea48df3f82
                    ...
                    <div class="pt-4 px-2">
                        <a href="https://wa.me/{{ $whatsappNumber }}" target="_blank"
                            class="w-full flex items-center justify-center bg-rbm-accent text-white font-bold py-3.5 rounded-xl shadow-lg gap-2 text-[12px]">
...
>>>>>>> 2c511e552552d96062ee847ba50016ea48df3f82
                ...
                <a href="https://wa.me/{{ $whatsappNumber }}" target="_blank"
                    class="w-11 h-11 bg-green-500 text-white shadow-2xl rounded-full flex items-center justify-center hover:bg-green-600 transition transform hover:scale-110 active:scale-90">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
                    ...
                    <div class="lg:pl-8">
                        <h4 class="font-bold text-white text-sm mb-6 relative inline-block uppercase tracking-wider">
                            Navigasi <span
                                class="absolute -bottom-2 left-0 w-8 h-0.5 bg-rbm-accent rounded-full"></span>
                        </h4>
                        <ul class="space-y-3 text-[13px] text-rbm-light-text font-medium">
                            <li><a href="/"
                                    class="hover:text-white transition-colors flex items-center gap-2"><i
                                        class="fa-solid fa-chevron-right text-[8px] text-rbm-accent"></i> Beranda</a>
                            </li>
                            <li><a href="{{ route('about') }}"
                                    class="hover:text-white transition-colors flex items-center gap-2"><i
                                        class="fa-solid fa-chevron-right text-[8px] text-rbm-accent"></i> Tentang
                                    Kami</a></li>
                            <li><a href="{{ route('news.index') }}"
                                    class="hover:text-white transition-colors flex items-center gap-2"><i
                                        class="fa-solid fa-chevron-right text-[8px] text-rbm-accent"></i> Berita
                                    Terbaru</a></li>
                            <li><a href="{{ route('gallery.index') }}"
                                    class="hover:text-white transition-colors flex items-center gap-2"><i
                                        class="fa-solid fa-chevron-right text-[8px] text-rbm-accent"></i> Galeri
                                    Proyek</a></li>
                        </ul>
                    </div>
...
<<<<<<< HEAD
                            <li><a href="{{ route('faq') }}"
                                    class="hover:text-white transition-colors flex items-center gap-2"><i
                                        class="fa-solid fa-chevron-right text-[8px] text-rbm-accent"></i> FAQ</a></li>
                            <li><a href="{{ route('kontak') }}"
                                    class="hover:text-white transition-colors flex items-center gap-2 group"><i
                                        class="fa-solid fa-chevron-right text-[8px] text-rbm-accent group-hover:translate-x-1 transition-transform"></i>
                                    Hubungi Kami</a></li>
                            <li><a href="{{ route('syaratketentuan') }}"
                                    class="hover:text-white transition-colors flex items-center gap-2"><i
                                        class="fa-solid fa-chevron-right text-[8px] text-rbm-accent"></i> Syarat &
                                    Ketentuan</a></li>
=======
                    ...
                    <div>
                        ...
                        <div class="space-y-4 text-[12px] text-rbm-light-text">
                            <div class="flex gap-3">
                                ...
                                <span class="leading-relaxed">Menara Palma Lantai 12, Jl. HR. Rasuna Said Kav. 6 Blok
                                    X-2, Jakarta Selatan 12950</span>
                            </div>
                            <div class="flex gap-3">
                                <i class="fas fa-map-marker-alt text-rbm-accent text-base shrink-0"></i>
                                <span class="leading-relaxed">Jl. Cilembu Haurngombong RT.01, RW.03 Kec. Pamulihan,
                                    Sumedang 45365</span>
                            </div>
